...
final class PrecinctProfileTests: XCTestCase {
    ...
    func testShareCardElectionPresentationKeepsNullProfilesNeutral() {
        ...
        XCTAssertEqual(missing.footer, "Election data unavailable. 2020 Census and American Community Survey.")
        ...
        XCTAssertEqual(available.footer, "2024 presidential vote. 2020 Census and American Community Survey.")
